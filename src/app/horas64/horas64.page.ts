...
@Component({
  selector: 'app-horas64',
  templateUrl: './horas64.page.html',
  styleUrls: ['./horas64.page.scss'],
})
export class Horas64Page implements OnInit {
  ...
  horas64ex() {
    this.navCtrl.navigateForward("horas64ex");
  }
